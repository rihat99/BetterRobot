"""Tests for the public configuration integrator."""
...
from better_robot.dynamics.integrators import integrate_q
...
def _two_link_planar():
    ...
    b.add_revolute_z("j1", parent="base", child="l1", origin=origin, lower=-math.pi, upper=math.pi)
    b.add_revolute_z("j2", parent="l1", child="l2", origin=origin, lower=-math.pi, upper=math.pi)
...
def test_integrate_q_handles_free_flyer():
    ...
    b.add_revolute_z("j1", parent="body", child="link", origin=origin, lower=-math.pi, upper=math.pi)
