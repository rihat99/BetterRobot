...
summary. See ``docs/15_EXTENSION.md`` and ``docs/17_CONTRACTS.md``.
"""
...
def test_public_all_has_25_symbols() -> None:
    """``better_robot.__all__`` is pinned at 25; see docs/01_ARCHITECTURE.md."""
    assert len(better_robot.__all__) == 25, (
        f"__all__ has {len(better_robot.__all__)}; expected 25 "
