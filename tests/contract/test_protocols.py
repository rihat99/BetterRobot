...
See ``docs/15_EXTENSION.md`` for the seam inventory and
``docs/07_RESIDUALS_COSTS_SOLVERS.md §5`` for the concrete Protocols.
"""
...
def test_protocol_is_runtime_checkable(proto: type) -> None:
    ...
    assert _is_runtime_checkable(proto), (
        ...
        f"docs/15_EXTENSION.md requires @runtime_checkable."
    )
