# {py:mod}`better_robot.io.build_model`

```{py:module} better_robot.io.build_model
```

```{autodoc2-docstring} better_robot.io.build_model
:allowtitles:
```
...
* - {py:obj}`build_model <better_robot.io.build_model.build_model>`
