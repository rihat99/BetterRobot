...
`````{py:class} AccelerationResidual(q: better_robot.residuals.utils.RobotVariableLike, *, dt: numbers.Real, weight: numbers.Real | torch.Tensor = 1.0, row_weight: better_robot.residuals.base.Weight | numbers.Real | torch.Tensor = 1.0, kernel: object | None = None, name: str = 'acceleration')
