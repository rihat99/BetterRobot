...
multi-robot, batch-axis picker) is §10 in ``docs/12_VIEWER.md``.
...
_FUTURE_MSG_RECORD = (
    "Visualizer.record is future work — see docs/12_VIEWER.md §10.1. "
    "V1 of the viewer is interactive-only."
)
_FUTURE_MSG_MULTI = (
    "Multi-robot sessions are future work — "
    "see docs/12_VIEWER.md §10.8."
)
_FUTURE_MSG_BATCH = (
    "Batch-axis picker is future work — see docs/12_VIEWER.md §10.9."
)
