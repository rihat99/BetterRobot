...
| `add_collision_geometry(robot_coll, q, ...)` | Add collision overlays, dispatches on mode (capsule or sphere) |
| `add_collision_capsules(robot_coll, q, ...)` | Add capsule overlays (approximated as icospheres along axis) |
| `add_collision_spheres(robot_coll, q, ...)` | Add sphere overlays (sphere mode only) |
...
| `update_collision_geometry(q, base_pose=None)` | Update collision overlays, dispatches on mode |
| `update_collision_capsules(q, base_pose=None)` | Update capsule overlay positions |
| `update_collision_spheres(q, base_pose=None)` | Update sphere overlay positions |
